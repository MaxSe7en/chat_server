import groupChatMessageHelpers from "./src/helpers/groupChatMessageHelpers.js";
import { query } from "./src/utils/dbUtils.js";
import { generateUniqueKeyForSenderAndReceiver } from "./src/utils/generateUniqueKeyForSenderAndReceiver.js";
import logger from "./src/utils/logger.js";
import redisClient from "./src/utils/redisClient.js";
// import "./src/"
async function abc(uid) {
...
let ax = await abc(199);
// console.log("lllll ", ax);
...
let key = "ChatList|roodev";

let nnn = await redisClient.hDel(key, "kofis");
